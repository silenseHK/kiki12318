<nav class="navbar navbar-expand-lg main-navbar">
    <a class="header-brand" href="index.html">
        <img src="/admin/assets/img/brand/logo.png" class="header-brand-img" alt="Kharna-Admin  logo">
    </a>
    ...
    <ul class="navbar-nav navbar-right">
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                ...
                <div class="dropdown-list-content">
                    <a href="#" class="dropdown-item dropdown-item-unread">
                        <img alt="image" src="/admin/assets/img/avatar/avatar-1.jpeg.jpg" class="rounded-circle dropdown-item-img">
                    ...
                    <a href="#" class="dropdown-item dropdown-item-unread">
                        <img alt="image" src="/admin/assets/img/avatar/avatar-2.jpeg.jpg" class="rounded-circle dropdown-item-img">
                        <div class="dropdown-item-desc">
                            <div class="dropdownmsg d-flex">
                                <div class="">
                                    <b>Jonathan North</b>
                    ...
                    <a href="#" class="dropdown-item">
                        <img alt="image" src="/admin/assets/img/avatar/avatar-4.jpeg.jpg" class="rounded-circle dropdown-item-img">
                        <div class="dropdown-item-desc">
                            <div class="dropdownmsg d-flex">
                                <div class="">
                                    <b>Victor Taylor</b>
                    ...
                    <a href="#" class="dropdown-item">
                        <img alt="image" src="/admin/assets/img/avatar/avatar-3.jpeg.jpg" class="rounded-circle dropdown-item-img">
                        <div class="dropdown-item-desc">
                            <div class="dropdownmsg d-flex">
                                <div class="">
                                    <b>Ruth	Arnold</b>
                    ...
                    <a href="#" class="dropdown-item">
                        <img alt="image" src="/admin/assets/img/avatar/avatar-5.jpeg.jpg" class="rounded-circle dropdown-item-img">
                        <div class="dropdown-item-desc">
                            <div class="dropdownmsg d-flex">
                                <div class="">
                                    <b>Sam	Lyman</b>
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg">
                <img src="/admin/assets/img/avatar/avatar-1.jpeg.jpg" alt="profile-user" class="rounded-circle w-32">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="javascript:;" onclick="logout()" class="dropdown-item has-icon">
